...
public class DoctorChatbotActivity extends AppCompatActivity {
    ...
    private void sendMessageToAI(String message) {
        // Show a brief delay to simulate AI thinking
        apiService.chat(new ChatRequest(message)).enqueue(new Callback<ChatResponse>() {
            ...
            public void onResponse(Call<ChatResponse> call, Response<ChatResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    addAIMessage("I'm sorry, I'm having trouble connecting to the medical database right now. Please try again later.");
                }
            }

            @Override
            public void onFailure(Call<ChatResponse> call, Throwable t) {
                addAIMessage("Network error. Please check your connection to the Embryo Metrix server.");
            }
        });
    }
